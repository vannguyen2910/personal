    ...
    <section className="pain on-dark">
        <div className="wrap">
          ...
          <ul className="pain-list">
            ...
            <li className="reveal reveal-d3"><em>04</em><span><span className="lang-en">Every fix is another prompt, and every re-explanation is more credit. By the 10th prompt, your AI credit runs out and the prototype still isn't finished.</span><span className="lang-vi">Mỗi lần sửa là thêm 1 prompt, mỗi lần giải thích lại là tốn thêm credit. Đến prompt thứ 10 là hết sạch AI credit mà prototype vẫn chưa xong.</span></span></li>
          </ul>
